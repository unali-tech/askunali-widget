if("undefined"==typeof askUnaliDefaultConfig){const askUnaliDefaultConfig={apiKey:"default",styles:{borderColor:null,borderRadius:null,questionBox:{backgroundColor:null,fontColor:null},answerBox:{backgroundColor:null,fontColor:null}}}}function getConfig(){var e=window.askUnaliConfig||{};return{...askUnaliDefaultConfig,...e}}function clearAnswer(){var e=document.getElementById("askunali-answer"),t=document.getElementById("askunali-sources"),n=document.getElementById("askunali-link"),i=document.getElementById("askunali-return-button"),a=document.getElementById("askunali-shopping-container"),o=document.getElementById("askunali-shopping-links");e&&(e.innerHTML=""),t&&hideElement(t),n&&hideElement(n),i&&hideElement(i),a&&hideElement(a),o&&(o.innerHTML="")}function resetWidget(){var e=document.getElementById("askunali-question_input_div"),e=(e&&(e.textContent="",e.classList.remove("not-empty")),clearAnswer(),document.getElementById("askunali-question-suggestions-container")),e=(e&&(e.style.display="block"),document.querySelector(".askunali-question-output-container")),e=(e&&(e.style.border="1px solid #D0DDE8",e.style.borderBottom="1px solid #D0DDE8"),document.querySelector(".askunali-question-output-container-bottom"));e&&(e.style.height="0",e.style.border="none")}function updateApiKey(e){window.askUnaliConfig={...window.askUnaliConfig,apiKey:e},resetWidget()}function highlightText(n,e){return e.forEach(e=>{var t=new RegExp(`\\b${e}\\b`,"gi");n=n.replace(t,`<a href="#" class="askunali-ingredient-link" style="color: #3366CC;">${e}</a>`)}),n}function createElement(e,t,n){e=document.createElement(e);return t&&(e.className=t),n&&(e.innerHTML=n),e}function typeText(t,n,i,a=30){let o=0;!function e(){o<n.length?(t.innerHTML+=n.charAt(o),o++,setTimeout(e,a)):i&&i()}()}function appendElement(e,t){e.appendChild(t)}function removeElement(e){e.parentNode.removeChild(e)}function showElement(e){e.style.display="flex"}function hideElement(e){e.style.display="none"}function getTimestamp(){return Date.now()}function formatTime(e){return e.toFixed(2)+" ms"}async function fetchAnswer(e){var t=getConfig();try{var n=await fetch("https://rag-api-e0qu.onrender.com/ask_question",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({question:e,api_key:t.apiKey})});if(n.ok)return await n.json();throw new Error("HTTP error! status: "+n.status)}catch(e){throw console.error("Error in fetchAnswer:",e),e}}async function fetchSuggestedQuestions(e){var t=["How to manage knee pain?","Is ginseng good for energy?","Can acupuncture help with migraine?","Type of yoga for anxiety?","Child constipation, what to do?","What is AskUnali?"];try{var n,i=await fetch("https://xybo-itpz-j8ne.p7.xano.io/api:pfjomY_8/get_suggested_questions?widget_api_key="+e,{method:"GET",headers:{"Content-Type":"application/json"}});return i.ok?(n=await i.json())&&0===n.length?(console.warn("Empty response from fetchSuggestedQuestions API. Falling back to default questions."),t):n:(console.error("HTTP error! status: "+i.status),t)}catch(e){return console.error("Error in fetchSuggestedQuestions:",e),t}}function startLoadingAnimation(){const e=document.getElementById("askunali-question-output-icon");e.classList.add("animate-svg"),setTimeout(()=>{e.classList.add("rotate")},100)}function stopLoadingAnimation(){const e=document.getElementById("askunali-question-output-icon");e.classList.remove("rotate"),e.classList.remove("animate-svg"),setTimeout(()=>{e.querySelectorAll('g[class^="outer-donut-"] > g').forEach(e=>{e.style.transform="translate(0, 0)"})},0)}function typeText(n,i,a){let o="",s=0;!function e(){var t;s<i.length?(t=i.charAt(s),o+=t,n.innerHTML=o,s++,setTimeout(e,20)):a&&a()}()}function fadeIn(t,e,n){t.style.opacity=0,t.style.display="block";let i=0;const a=10/e;!function e(){i+=a,(t.style.opacity=i)<1?setTimeout(e,10):n()}()}const animationStyles=`
